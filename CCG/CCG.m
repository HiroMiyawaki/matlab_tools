function [out, t, Pairs] = CCG(T, G, BinSize, HalfBins, SampleRate, Normalization,GSubset,  Epochs)
% constructs multiple cross and Auto correlogram
% usage: [ccg, t, pairs] = CCG(T, G, BinSize, HalfBins, SampleRate, Normalization, GSubset, Epochs)
%
...
% SampleRate is for x-axis scaling only.  It defaults to 32552
...
% 'count' indicates that the y axis should show the raw spike count in each bin.  (default)
% 'hz' will normalize to give the conditional intensity of cell 2 given that cell 1 fired a spike
...
for g1=1:nGroups, for g2=1:nGroups %for g2=g1:nGroups
