...
for n=1:4
    switch n
        case 1
            dataDirRoot='~/data/OCU/eyelid_pip/HR0033/';
        case 2
            dataDirRoot='~/data/OCU/eyelid_pip/HR0034/';
        case 3
            dataDirRoot='~/data/OCU/eyelid_pip/HR0035/';
        case 4
            dataDirRoot='~/data/OCU/eyelid_pip/HR0036/';
        otherwise
            continue
    end
...
doAppend='';
savePdfName='~/data/OCU/eyelid_pip/summary.ps';
ratNameList={'HR0033','HR0034','HR0035','HR0036'};
close all
