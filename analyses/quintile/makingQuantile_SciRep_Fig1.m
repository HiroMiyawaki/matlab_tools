...
exPanel.a=loadGraph('quantile2','g1a');
exPanel.b=loadGraph('quantile2','g1b');
...
for epochIdx=1:2
    ...
    panel0.(alphabet(epochIdx))=loadGraph('quantile2',['f' num2str(epochIdx) 'a']);
    ...
    panel5.(alphabet(epochIdx))=loadGraph('quantile2', ['e' num2str(toUse(epochIdx))]);
...
for epochIdx=1:2
    ...
    panel0.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile2',['f' num2str(epochIdx+2) 'a'])
    ...
    panel1.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '1' postFix]);
    panel1b.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '1' 'Inh' postFix]);
    panel2.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '2' postFix]);
    
    if showMI
        panel3.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3a' postFix]);
        panel4.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4a' postFix]);

        panel3b.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3a' 'Inh' postFix]);
        panel4b.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4a' 'Inh' postFix]);
    else
        panel3.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3b' postFix]);
        panel4.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4b' postFix]);

        panel3b.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3b' 'Inh' postFix]);
        panel4b.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4b' 'Inh' postFix]);
    end
    panel3.(alphabet(epochIdx+alphabetGap)).type='multiColorBar';
    panel4.(alphabet(epochIdx+alphabetGap)).type='multiColorBar';

    panel5.(alphabet(epochIdx+alphabetGap))=loadGraph('quantile3', ['e' num2str(toUse(epochIdx)-(toUse(epochIdx)>4)) postFix]);
