% quantile5_nremLOWnrem
% quantile5_LOWnremLOW
% quantile5_zscore_nremLOWnrem
% quintile5_distribution

% quantile5_LOWnremLOWInh
% quantile5_nremLOWnremInh

% quantile_excludeLow
% quantile_excludeLowInh

% quantile5_MaNremMa
% quantile5_MaNremMaInh

% quantile5_NremMaNrem
% quantile5_NremMaNremInh
...
for epochIdx=1:length(toUse)
    panel1.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '1']);
    panel2.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '2']);
    panel2b.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '2' 'Inh']);
    
    if showMI
        panel3.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '3a']);
        panel4.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '4a']);
        panel3b.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '3a' 'Inh']);
        panel4b.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '4a' 'Inh']);
    else
        panel3.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '3b']);
        panel4.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '4b']);
        panel3b.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '3b' 'Inh']);
        panel4b.(alphabet(epochIdx))=loadGraph('quantile5', [alphabet(toUse(epochIdx)) '4b' 'Inh']);
    end
...
%     panel5.(alphabet(epochIdx))=loadGraph('quantile5', ['e' num2str(toUse(epochIdx))]);
