...
panel3.a.info.YLim=[-0.125,0.25];
panel3.b.info.YLim=[-0.25,0.5];
panel3.c.info.YLim=[-0.4,0.5];
panel3.c.info.YTick=-0.3:0.3:0.3;
panel3.c.info.YTickLabel=panel3.c.info.YTick;
panel3.d.info.YLim=[-0.5,0.75];

panel4.a.info.YLim=[-0.02,0.1];
panel4.a.info.YTick=0:0.04:0.08;
panel4.a.info.YTickLabel=panel4.a.info.YTick;

panel4.b.info.YLim=[-0.15,0.025];
panel4.b.info.YTick=-0.15:0.05:0;
panel4.b.info.YTickLabel=panel4.a.info.YTick;

panel4.c.info.YLim=[-1,0.25];
panel4.c.info.YTick=-1:0.5:0.5;
panel4.c.info.YTickLabel=panel4.c.info.YTick;

panel4.d.info.YLim=[-0.2,0.25];
...
for idx=1:length(fieldnames(panel0))
    ...
    panel0.(alphabet(idx)).color=[panel3.(alphabet(idx)).color;0.5*[1,1,1]];
end
%%
close all
origX=15;
