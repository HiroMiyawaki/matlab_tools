...
% quantile4_sleep2Wake1min
% quantile4_wakePrePostSleep
% quantile4_stableWake
%%
...
for epochIdx=1:length(toUse)
    ...
    panel1.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(panelIdx)) '1' postFix]);
    panel1b.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(panelIdx)) '1' 'Inh' postFix]);
    panel2.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '2' postFix]);
    
    if showMI
        panel3.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3a' postFix]);
        panel4.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4a' postFix]);

        panel3b.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3a' 'Inh' postFix]);
        panel4b.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4a' 'Inh' postFix]);
    else
        panel3.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3b' postFix]);
        panel4.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4b' postFix]);

        panel3b.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '3b' 'Inh' postFix]);
        panel4b.(alphabet(panelIdx))=loadGraph('quantile3', [alphabet(toUse(epochIdx)) '4b' 'Inh' postFix]);
    end
    panel3.(alphabet(panelIdx)).type='multiColorBar';
    panel4.(alphabet(panelIdx)).type='multiColorBar';

    panel5.(alphabet(panelIdx))=loadGraph('quantile3', ['e' num2str(toUse(epochIdx)-(toUse(epochIdx)>4)) postFix]);
...
for epochIdx=1:length(toUse)
    ...
    panel1.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '1' postFix]);
    panel1b.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '1' 'Inh' postFix]);
    panel2.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '2' postFix]);
    
    if showMI
        panel3.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '3a' postFix]);
        panel4.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '4a' postFix]);
        panel3b.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '3a' 'Inh' postFix]);
        panel4b.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '4a' 'Inh' postFix]);
    else
        panel3.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '3b' postFix]);
        panel4.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '4b' postFix]);
        panel3b.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '3b' 'Inh' postFix]);
        panel4b.(alphabet(panelIdx))=loadGraph('quantile4', [alphabet(toUse(epochIdx)) '4b' 'Inh' postFix]);
    end
    panel3.(alphabet(panelIdx)).type='multiColorBar';
    panel4.(alphabet(panelIdx)).type='multiColorBar';
    
    panel5.(alphabet(panelIdx))=loadGraph('quantile4', ['e' num2str(toUse(epochIdx)) postFix]);
