...
for tIdx=1:length(tNameList)
    ...
    saveGraph('quantile20s3',[alphabet(tIdx) '1'],...
        'scatter',...
        xVal,... %x
        yVal,... %y
        [],... %error 
    ...
    saveGraph('quantile20s3',[alphabet(tIdx) '2'],...
        'spectrum',...
...
for tIdx=1:length(tNameList)
    ...
    for mIdx=1:length(measureList)
        ...
        saveGraph('quantile20s3',[alphabet(tIdx) '3' alphabet(mIdx)],...
            'multiColorBar',...
            1:nDiv,... %x
        ...
        param.measure=measureName;
         ...
         saveGraph('quantile20s3',[alphabet(tIdx) '4' alphabet(mIdx)],...
            'multiColorBar',...
            1:nDiv,... %x
...
text2(0,-1,{
    ...
    %%
print(fh,'~/Dropbox/EarlyLate/changeOnTransitions_20s.pdf','-dpdf')         
