...
for tIdx=1:length(tNameList)
    ...
    saveGraph('quantile20s3',[alphabet(tIdx) '1' 'Inh' 'exLOW'],...
        'scatter',...
        xVal,... %x
        yVal,... %y
        [],... %error 
    ...
    param.smotCorehSD=1;
    saveGraph('quantile20s3',[alphabet(tIdx) '2' 'Inh'  'exLOW'],...
        'spectrum',...
...
for tIdx=1:length(tNameList)
    ...
    for mIdx=1:length(measureList)
        ...
        saveGraph('quantile20s3',[alphabet(tIdx) '3' alphabet(mIdx) 'Inh'  'exLOW'],...
            'multiColorBar',...
            1:nDiv,... %x
        ...
        param.measure=measureName;
         ...
         saveGraph('quantile20s3',[alphabet(tIdx) '4' alphabet(mIdx) 'Inh'  'exLOW'],...
            'multiColorBar',...
            1:nDiv,... %x
