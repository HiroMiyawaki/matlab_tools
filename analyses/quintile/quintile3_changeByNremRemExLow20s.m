...
for tIdx=1:length(tNameList)
    ...
    saveGraph('quantile20s3',[alphabet(5+tIdx) '1' 'exLow'],...
        'scatter',...
        xVal,... %x
        yVal,... %y
        [],... %error 
    ...
    param.smotCorehSD=1;
    saveGraph('quantile20s3',[alphabet(5+tIdx) '2' 'exLow'],...
        'spectrum',...
...
for tIdx=1:length(tNameList)
    ...
    for mIdx=1:length(measureList)
        ...
        saveGraph('quantile20s3',[alphabet(5+tIdx) '3' alphabet(mIdx) 'exLow'],...
            'multiColorBar',...
            1:nDiv,... %x
        ...
        param.measure=measureName;
         ...
         saveGraph('quantile20s3',[alphabet(5+tIdx) '4' alphabet(mIdx) 'exLow'],...
            'multiColorBar',...
            1:nDiv,... %x
