...
for tIdx=1:length(tNameList)
    ...
    saveGraph('quantile20s3',[alphabet(5+tIdx) '1' 'Inh' 'exLow'],...
        'scatter',...
        xVal,... %x
        yVal,... %y
        [],... %error 
    ...
    param.smotCorehSD=1;
    saveGraph('quantile20s3',[alphabet(5+tIdx) '2' 'Inh' 'exLow'],...
        'spectrum',...
...
for tIdx=1:length(tNameList)
    ...
    for mIdx=1:length(measureList)
        ...
        saveGraph('quantile20s3',[alphabet(5+tIdx) '3' alphabet(mIdx) 'Inh' 'exLow'],...
            'multiColorBar',...
            1:nDiv,... %x
        ...
        param.measure=measureName;
         ...
         saveGraph('quantile20s3',[alphabet(5+tIdx) '4' alphabet(mIdx) 'Inh' 'exLow'],...
            'multiColorBar',...
            1:nDiv,... %x
