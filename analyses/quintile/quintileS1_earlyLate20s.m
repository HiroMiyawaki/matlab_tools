...
dispName.nrem='Within non-REM';
dispName.rem='Within REM';
dispName.nrem2rem='Non-REM to REM';
dispName.rem2nrem='REM to non-REM';

psFileName='~/Dropbox/Quantile/preliminary/earlyLate_20s.ps';
doAppend='';
...
for tIdx=1:length(tNameList)
    ...
    for pIdx=1:length(pNameList)
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx) '1' alphabet(pIdx)],...
            'scatter',...
            xVal,... %x
            yVal,... %y
            [],... %error
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx) '2' alphabet(pIdx)],...
            'spectrum',...
        ...
        for mIdx=1:length(measureList)
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx) '3' alphabet(mIdx) num2str(pIdx)],...
                'multiColorBar',...
                1:nDiv,... %x
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx) '4' alphabet(mIdx) num2str(pIdx)],...
                'multiColorBar',...
                1:nDiv,... %x
