...
psFileName='~/Dropbox/Quantile/preliminary/earlyLate-inh_exLOW_20s.ps';
doAppend='';
...
for tIdx=1:length(tNameList)
    ...
    for pIdx=1:length(pNameList)
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx) '1' alphabet(pIdx) 'Inh' 'exLow'],...
            'scatter',...
            xVal,... %x
            yVal,... %y
            [],... %error
        ...
        param.smotCorehSD=1;
        saveGraph('quantile20sS2',[alphabet(tIdx) '2' alphabet(pIdx) 'Inh' 'exLow'],...
            'spectrum',...
        ...
        for mIdx=1:length(measureList)
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx) '3' alphabet(mIdx) num2str(pIdx) 'Inh' 'exLow'],...
                'multiColorBar',...
                1:nDiv,... %x
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx) '4' alphabet(mIdx) num2str(pIdx) 'Inh' 'exLow'],...
                'multiColorBar',...
                1:nDiv,... %x
