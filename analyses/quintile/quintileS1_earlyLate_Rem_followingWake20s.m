...
psFileName='~/Dropbox/Quantile/preliminary/earlyLateRem_afterWakeREM_20s.ps';
doAppend='';
...
for tIdx=processList
    ...
    for pIdx=1:length(pNameList)
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx+9) '1' alphabet(pIdx)],...
            'scatter',...
            xVal,... %x
            yVal,... %y
            [],... %error
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx+9) '2' alphabet(pIdx)],...
            'spectrum',...
        ...
        for mIdx=1:length(measureList)
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx+9) '3' alphabet(mIdx) num2str(pIdx)],...
                'multiColorBar',...
                1:nDiv,... %x
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx+9) '4' alphabet(mIdx) num2str(pIdx)],...
                'multiColorBar',...
                1:nDiv,... %x
