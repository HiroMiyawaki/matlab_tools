...
for tIdx=processList
    ...
    for pIdx=1:length(pNameList)
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx+4) '1' alphabet(pIdx)],...
            'scatter',...
            xVal,... %x
            yVal,... %y
            [],... %error
        ...
        param.smotCorehSD=1;
        saveGraph('quantile20sS2',[alphabet(tIdx+4) '2' alphabet(pIdx)],...
            'spectrum',...
        ...
        for mIdx=1:length(measureList)
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx+4) '3' alphabet(mIdx) num2str(pIdx)],...
                'multiColorBar',...
                1:nDiv,... %x
            ...
            saveGraph('quantile20sS2',[alphabet(tIdx+4) '4' alphabet(mIdx) num2str(pIdx)],...
                'multiColorBar',...
                1:nDiv,... %x
