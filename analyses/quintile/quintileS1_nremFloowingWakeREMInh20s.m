...
for tIdx=1:length(tNameList)
    ...
    saveGraph('quantile20sS2',[alphabet(tIdx+4) '1'  'Inh'],...
        'scatter',...
        xVal,... %x
        yVal,... %y
        [],... %error
    ...
    param.smotCorehSD=1;
    saveGraph('quantile20sS2',[alphabet(tIdx+4) '2'  'Inh'],...
        'spectrum',...
    ...
    subplot2(nRaw,nCol,2+3*floor((tIdx-1)/2),2*mod(tIdx-1,2)+mIdx)
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx+4) '3' alphabet(mIdx) 'Inh'],...
            'multiColorBar',...
            1:nDiv,... %x
     ...
     subplot2(nRaw,nCol,3+3*floor((tIdx-1)/2),2*mod(tIdx-1,2)+mIdx)
       hold on
        ...
        saveGraph('quantile20sS2',[alphabet(tIdx+4) '4' alphabet(mIdx) 'Inh'],...
            'multiColorBar',...
            1:nDiv,... %x
