...
for bIdx=1:length(bTypeList)
    ...
    saveGraph('quantile20s2',['f' num2str(bIdx+2) 'asingle'],...
            'line',...
            xVal,... %x
            yVal,... %y
            eVal,... %error 
    ...
    saveGraph('quantile20s2',['f' alphabet(bIdx) '2single'],...
            'line',...
            0:nPeriodTotal-1,... %x
...
print(fh,'~/Dropbox/Quantile/preliminary/TimeNormalized_transition_singlePeriod.pdf','-dpdf')
