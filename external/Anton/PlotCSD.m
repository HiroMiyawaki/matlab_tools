...
[step, ColorRange, scale, SeeOutTrace, WhichCSDCh,csdtype,orient] =DefaultArgs(varargin, {2,[], 1,0, [],'c',[]});
...
if iscell(y)
    ...
    for n1=1:ny
        for n2 = 1:nx
            ...
            PlotCSD(y{n1,n2}, tcur, csdch, step, ColorRange, scale, SeeOutTrace, WhichCSDCh, csdtype);
        end
    end
else
    % single plot routine
...
if SeeOutTrace
    ...
    if strcmp(csdtype,'c')
        ...
        if SeeOutTrace 
            ...
            PlotManyCh(y,t, 1250, scale , 'k', 0, AxesIncr);
        else
