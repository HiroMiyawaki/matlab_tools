function [y,f, t, phi, yerr, phierr]=mtptchg(varargin)
%function [y, f,t,  phi, yerr, phierr]=mtptchg(x,Res, Clu, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange,CluSubset,Segments, pval, MinSpikes);
...
[yo, f, t] = mtptcsg(x,Res, Clu, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange,CluSubset,Segments,pval,MinSpikes);
...
%             y(:,:,Ch1, Ch2) = abs(yo(:,:,Ch1, Ch2)) ./ normpow;
            y(:,:,Ch1, Ch2) = yo(:,:,Ch1, Ch2) ./ (normpow+eps);

            if nargout>2
                phi(:,:,Ch1,Ch2) = angle(yo(:,:,Ch1, Ch2) ./(normpow+eps));
            end
