function [y,f, t, phi, yerr, phierr]=mtptchg_segs(varargin)
...
[yo, f, t] = mtptcsg_segs(x,Res, Clu, nFFT,Fs,WinLength,winstep,NW,Detrend,nTapers, FreqRange,CluSubset,Starts,pval,MinSpikes);
% [yo, f, t] = mtptcsg_segs(x,Res, Clu, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange,CluSubset,Segments,pval,MinSpikes);
