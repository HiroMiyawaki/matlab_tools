% function sdetected = sdetect_a(inname,numchannel,channels,highband,lowband,thresholdf,verbose)
...
buffersize = 2^16; % buffer size ... the larger the faster, as long as
...
max_sw_period = 250; % maximum sharpwave period = 150ms ~ 30 cycles
                     % of ripples
