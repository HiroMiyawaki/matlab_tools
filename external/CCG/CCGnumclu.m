function [ccg,t] = CCGnumclu(fileinfo,pair,BinSize,HalfBins,thetafilt,runfilt,ripplefilt);
...
shank1 = numclu(pair(1),1);
cluster1 = numclu(pair(1),2);
shank2 = numclu(pair(2),1);
cluster2 = numclu(pair(2),2);
...
%     [ccg{nn},t,prs] = CCG(res(find_nn,1),res(find_nn,2),BinSize,HalfBins,32552,'count',unique(res(find_nn,2)));
% 
%     figure(1)
%     subplot(2,2,nn)
