...
%
% [LL, PRIOR, TRANSMAT, OBSMAT] = LEARN_HMM(DATA, PRIOR0, TRANSMAT0, OBSMAT0) computes ML
% estimates of the following parameters, where, for each time t, Q(t) is the hidden state, and
