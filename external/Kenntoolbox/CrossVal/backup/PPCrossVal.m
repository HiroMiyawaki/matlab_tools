% [LikRat Est] = PPCrossVal(Res, IndVars, TrainFn, TestFn, nCrossVal, GoodRanges)
%
...
% are added and returned as LikRat.  Logs are to base 2.
%
% Input variables:
%
...
% which the parameters should be derived.
%
...
function [LikRat, Est] = PPCrossVal(Res, IndVars, TrainFn, TestFn, nCrossVal, GoodRanges)
...
%	fprintf('%f bits per (sec?), %f per spike. est %f\n', 20000*Delta/TotTime, Delta/nSpikes, 20000*Est1/TotTime);
if 0
