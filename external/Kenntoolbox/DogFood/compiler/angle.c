 ...
 * M-function from file "/u2/local/matlab6.1/toolbox/matlab/elfun/angle.m"
 * (lines 1-17). This function processes any input arguments and passes them to
 ...
 * M-function from file "/u2/local/matlab6.1/toolbox/matlab/elfun/angle.m"
 * (lines 1-17). The feval function calls the implementation version of angle
 ...
 * M-function from file "/u2/local/matlab6.1/toolbox/matlab/elfun/angle.m"
 * (lines 1-17). It contains the actual compiled code for that M-function. It
