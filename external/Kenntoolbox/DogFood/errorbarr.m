function hh = errorbarr(x, y, l,u,symbol)
%ERRORBARR Modified rror bar plot.
%   This is like the ordinary ERRORBAR function except that the LineSpec
%   argument applies to the error bars too (in the original, errorbars
%   were always solid).
%
...
esymbol = [ls col]; % no markers for errorbars
