...
% [HalfDist, WorstBurstRat, WorstBurstRatAt] = ClusterQuality(Fet, MySpikes, Res, BurstTimeWin)
%
...
function [HalfDist, WorstBurstRat, WorstBurstRatAt] = ClusterQuality(Fet, MySpikes, Res, BurstTimeWin)
