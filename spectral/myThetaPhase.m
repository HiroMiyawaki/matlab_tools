% [ThetaPhase ThetaAmp TotPhase] = myThetaPhase(Eeg, FreqRange, FilterOrd, Ripple)
%
...
% function [ThetaPhase, ThetaAmp, TotPhase] = ThetaPhase(Eeg, FreqRange, FilterOrd, Ripple, SampleRate)
%function [ThetaPhase, ThetaAmp, TotPhase] = myThetaPhase(Eeg, varargin)
