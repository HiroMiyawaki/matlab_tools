...
if imageRange(1)<sCoreSize+1; imageRange(1)=sCoreSize+1;end
if imageRange(2)>vr.Height-sCoreSize; imageRange(2)=vr.Height-sCoreSize;end
if imageRange(3)<sCoreSize+1; imageRange(3)=sCoreSize+1;end
if imageRange(4)>vr.Width-sCoreSize; imageRange(4)=vr.Width-sCoreSize;end
...
% 
% if max(xRange)>vr.Height
%     xRange(xRange>vr.Height)=[];
% end
% if min(xRange)<1
%     xRange(xRange<1)=[];
% end
% 
% if max(yRange)>vr.Width
%     yRange(yRange>vr.Width)=[];
% end
% if min(yRange)<1
%     yRange(yRange<1)=[];
% end
